...
from oss_workflow_osismodelbase import oss_workflow_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_workflow(OsisBaseObject,oss_workflow_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_workflow_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
