...
from oss_contactmethod_osismodelbase import oss_contactmethod_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_contactmethod(OsisBaseObject,oss_contactmethod_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_contactmethod_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
