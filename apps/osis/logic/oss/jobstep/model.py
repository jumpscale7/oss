...
from oss_jobstep_osismodelbase import oss_jobstep_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_jobstep(OsisBaseObject,oss_jobstep_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_jobstep_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
