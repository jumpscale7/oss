...
from oss_document_osismodelbase import oss_document_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_document(OsisBaseObject,oss_document_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_document_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
