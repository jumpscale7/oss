...
from oss_assettype_osismodelbase import oss_assettype_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_assettype(OsisBaseObject,oss_assettype_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_assettype_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
