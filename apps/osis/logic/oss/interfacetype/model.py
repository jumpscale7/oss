...
from oss_interfacetype_osismodelbase import oss_interfacetype_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_interfacetype(OsisBaseObject,oss_interfacetype_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_interfacetype_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
