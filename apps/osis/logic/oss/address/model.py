...
from oss_address_osismodelbase import oss_address_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_address(OsisBaseObject,oss_address_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_address_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
