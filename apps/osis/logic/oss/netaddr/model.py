...
from oss_netaddr_osismodelbase import oss_netaddr_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_netaddr(OsisBaseObject,oss_netaddr_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_netaddr_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
