...
from oss_ticket_osismodelbase import oss_ticket_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_ticket(OsisBaseObject,oss_ticket_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_ticket_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
