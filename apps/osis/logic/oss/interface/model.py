...
from oss_interface_osismodelbase import oss_interface_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_interface(OsisBaseObject,oss_interface_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_interface_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
