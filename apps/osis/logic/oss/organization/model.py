...
from oss_organization_osismodelbase import oss_organization_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_organization(OsisBaseObject,oss_organization_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_organization_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
