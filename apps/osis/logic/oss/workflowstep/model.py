...
from oss_workflowstep_osismodelbase import oss_workflowstep_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_workflowstep(OsisBaseObject,oss_workflowstep_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_workflowstep_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
