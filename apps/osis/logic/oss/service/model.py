...
from oss_service_osismodelbase import oss_service_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_service(OsisBaseObject,oss_service_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_service_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
