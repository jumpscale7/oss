...
from oss_machine_osismodelbase import oss_machine_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_machine(OsisBaseObject,oss_machine_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_machine_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
