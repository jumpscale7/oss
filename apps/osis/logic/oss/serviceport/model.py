...
from oss_serviceport_osismodelbase import oss_serviceport_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_serviceport(OsisBaseObject,oss_serviceport_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_serviceport_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
