...
from oss_componenttype_osismodelbase import oss_componenttype_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_componenttype(OsisBaseObject,oss_componenttype_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_componenttype_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
