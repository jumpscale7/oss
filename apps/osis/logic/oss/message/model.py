...
from oss_message_osismodelbase import oss_message_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_message(OsisBaseObject,oss_message_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_message_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
