...
from oss_brandtype_osismodelbase import oss_brandtype_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_brandtype(OsisBaseObject,oss_brandtype_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_brandtype_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
