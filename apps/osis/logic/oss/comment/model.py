...
from oss_comment_osismodelbase import oss_comment_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_comment(OsisBaseObject,oss_comment_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_comment_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
