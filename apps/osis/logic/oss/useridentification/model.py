...
from oss_useridentification_osismodelbase import oss_useridentification_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_useridentification(OsisBaseObject,oss_useridentification_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_useridentification_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
