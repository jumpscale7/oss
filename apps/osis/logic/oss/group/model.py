...
from oss_group_osismodelbase import oss_group_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_group(OsisBaseObject,oss_group_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_group_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
