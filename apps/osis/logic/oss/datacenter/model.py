...
from oss_datacenter_osismodelbase import oss_datacenter_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_datacenter(OsisBaseObject,oss_datacenter_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_datacenter_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
