...
from oss_asset_osismodelbase import oss_asset_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class oss_asset(OsisBaseObject,oss_asset_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        oss_asset_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
